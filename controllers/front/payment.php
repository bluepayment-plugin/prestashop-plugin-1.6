...
class BluePaymentPaymentModuleFrontController extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        if ($gateway_id !== 0) {
            $hash_data = array($service_id, $order_id, $amount, $gateway_id, $this->context->currency->iso_code, $customer_email, $shared_key);
        } else {
            $hash_data = array($service_id, $order_id, $amount, $this->context->currency->iso_code, $customer_email, $shared_key);
        }
